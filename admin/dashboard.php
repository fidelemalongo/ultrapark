...
<html>
<head>
<title>UP | Admin Dashboard</title>
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								...
								<?php $sql = "SELECT  id_parent from t_parents";
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3>Children</h3>
								<?php $sql1 = "SELECT id_enfant from t_enfants";
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Category</h3>
								<?php $sql2 = "SELECT id_categorie from t_categories";
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							...
							<div class="four-text">
								<h3>Ticket Sold</h3>
								<?php $sql3 = "SELECT id_ticket from t_tickets";
