...
$sql="INSERT INTO  t_parents(noms,genre,adresse_physique,mail,telephone,pass,etat)
 VALUES(:fname,:genre,:adreP,:email,:mnumber,:password,:etat)";
$query = $dbh->prepare($sql);
$query->bindParam(':fname',$fname,PDO::PARAM_STR);
$query->bindParam(':genre',$genre,PDO::PARAM_STR);
$query->bindParam(':adreP',$adreP,PDO::PARAM_STR);
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
				...
				<select name="genre" class="form-control" placeholder="ddd">
					<option></option>
					<option value="M">M</option>
					<option value="F">F</option>
				</select>
				<input type="text" value="" placeholder="Your physical address" name="adreP" autocomplete="off" required="">
